...
We make use of the `renv` package to make sure that everyone is using the consistent set of packages.  This also makes it very straightforward to install all the necessary packages without having to manually install them individually.
